<template>
  <div class="max-w-2xl mx-auto p-6">
    <div class="bg-white rounded-lg shadow-lg p-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-8 text-center">MYPM</h1>
      <p class="text-center text-gray-600 mb-8">My Private Mail</p>
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        >
          {{ store.loading ? 'Connecting...' : 'Connect' }}
        </button>
      </form>

      <!-- Error Message -->
      <div v-if="store.error" class="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
